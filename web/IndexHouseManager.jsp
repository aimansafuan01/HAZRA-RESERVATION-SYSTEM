                        ...
                        <div class="col-md-6 pe-0">
                            <div class="card-body border-right border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight mb-3">
                                    ...
                                    <div class="ps-3">
                                        <div class="mb-2">
                                            <a href="updateRoomStatus.jsp" class="h5 font-weight-bolder text-decoration-none text-dark">Manage House & Room</a>
                                        </div>
                                        <p class="text-muted">
                        ...
                        <div class="col-md-6 ps-0">
                            <div class="card-body border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight mb-3">
                                    ...
                                    <div class="ps-3">
                                        <div class="mb-2">
                                            <a href="UpdateEmployeeAccountHM.jsp" class="h5 font-weight-bolder text-decoration-none text-dark">Update Account</a>
                                        </div>
