<%-- 
    Document   : index
    Created on : Jan 2, 2023, 1:49:17 AM
    Author     : User
--%>
...
<html lang="en">
  <head>
    <title>Hazra Homestay Change Test</title>
    <meta charset="utf-8">
                ...
                <div class="justify-content-center collapse navbar-collapse mx-4" id="navbarNav">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item mx-4">
                            <a class="btn btn-dark" href="Login.jsp"><h6>Login</h6></a>                  
                            <a class="btn btn-dark" href="Register.jsp"><h6>Register</h6></a>
                      </li>
                    </ul>
                </div>
            </nav>
                                          ...
                                          <div class="p-2">
                                              <div class="mb-2">
                                                  <button type="button" class="btn btn-white" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                      <a class="h5 font-weight-bolder text-dark">Check Available Date</a>
                                                    </button>
                                                          ...
                                                          <div class="modal-header">
                                                            ...
                                                            <script>
                                                              ...
                                                              function setMinCheckOutDate() {
                                                                ...
                                                                document.getElementById("exampleInputDate").min = checkInDate;
                                                              }
                                                            </script>
                                                            
                                                            <form action="Houseroomguest.jsp" method='POST'>
                                                                 <div class="modal-body">
                                                            <label>Check in Date</label>
                                                            <input type="text" name="checkindate" class="form-control" id="checkInDate" placeholder="Enter date" min="" onfocus="(this.type='date')" onblur="(this.type='text')" onchange="setMinCheckOutDate()">
                                                           <label for="exampleInputDate">Check Out Date</label>
                                                           <input type="text" name="checkoutdate" class="form-control" id="exampleInputDate" placeholder="Enter date" min="" onfocus="(this.type='date')" onblur="(this.type='text')">
                                                            <label for="exampleInputNumberOfPeople">Number of people</label>
                                                            <input type="number" name="numpeople "class="form-control" id="exampleInputNumberOfPeople" placeholder="Enter number of people" min="1">
                                                          </div>
                                                          
                                                          <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                               <input class="btn btn-outline-secondary primary" type='submit' value='Find Room'>
                                                          </div>
                                                            </form>
